...
int main() {
    ...
    MLP* loaded_mlp = load_mlp(model_fname, batch_size, cublaslt_handle);
    ...
    CHECK_CUDA(cudaMemcpy(layer_output, loaded_mlp->d_layer_output, batch_size * output_dim * sizeof(float), cudaMemcpyDeviceToHost));
